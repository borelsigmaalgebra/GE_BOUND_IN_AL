...
plot_data <- data.frame(
  ...
  RS = rad_compl_rs[-c(1,13)],
  
  SQBCR_REG_SUB_4 = rad_compl_sqbcr_reg_4[-c(1,13)] ,
  SQBCR_REG_SUB_10 = rad_compl_sqbcr_reg_10[-c(1,13)] ,
  SQBCR_REG_SUB_25 = rad_compl_sqbcr_reg_25 [-c(1,13)],
  
  SQBCR_AREG_SUB_4 = rad_compl_sqbcr_areg_4[-c(1,13)] ,
  SQBCR_AREG_SUB_10 = rad_compl_sqbcr_areg_10[-c(1,13)] ,
  SQBCR_AREG_SUB_25 = rad_compl_sqbcr_areg_25[-c(1,13)] ,
  
  QBCR_AREG_SUB_4 = rad_compl_qbcr_areg_4[-c(1,13)] ,
  QBCR_AREG_SUB_10 = rad_compl_qbcr_areg_10[-c(1,13)] ,
  QBCR_AREG_SUB_25 = rad_compl_qbcr_areg_25[-c(1,13)] ,
  
  QBCR_REG_SUB_4 = rad_compl_qbcr_4[-c(1,13)] ,
  QBCR_REG_SUB_10 = rad_compl_qbcr_10[-c(1,13)] ,
  QBCR_REG_SUB_25 = rad_compl_qbcr_25[-c(1,13)]
)
...
# Create the ggplot
plot_4 <- ggplot(plot_data_long, aes(x = n_training_data, y = Rad_Compl, color = Method, shape = Method)) +
  geom_line(size = 0.8) +
  ...
  scale_y_continuous(
    limits = c(
      min(plot_data_long$Rad_Compl, na.rm = TRUE),
      max(plot_data_long$Rad_Compl, na.rm = TRUE)
    )
  ) +
